...
Configuration
------------------------
If something doesn't work please contact me on discord ().
*/
...
const config = {
    serverInfo: {
        ...
        serverName: "The Unified Realms", /*Server name*/
        serverIp: "unifiedrealms.aspirehosting.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1433173821086761102" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    All skins for original players are generate automaticaly. If you want to add skins to warez players, yout must add url for skin to skinUrlOrPathToFile
        {
            inGameName: "End3rVerse",  <--- In-Game name
            rank: "Owner",  <-- rank
    ...
    */
    ...
    adminTeamPage: {
        leaders: [
            {
                ...
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(0, 238, 255, 1)"
            },
            {
                inGameName: "DragonKingBoie",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(3, 226, 255, 1)"
            },
            {
                inGameName: "Dragon_Lucky",
                rank: "Co-Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(3, 226, 255, 1)"
            },
        ...
        heads: [
            ...
            {
                inGameName: "Neha",
                rank: "Quality Control Cordinator",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 116, 3, 1)"
            },
            {
                inGameName: "Aman",
                rank: "Developer",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(247, 3, 255, 1)"
            },
            {
                inGameName: "GurveerPlayz",
                rank: "Handler",
                skinUrlOrPathToFile: "https://namemc.com/skin/fae5b82403842517",
                rankColor: "rgba(176, 59, 187, 1)"
            },
            {
                inGameName: "NikhilMnhotra",
                rank: "Handler",
                skinUrlOrPathToFile: "https://namemc.com/skin/b52a2a0bf0670f1f",
                rankColor: "rgba(176, 59, 187, 1)"
            }
        ]
    },
    ...
    */
    contactPage: {
        email: "theunifiedrealms@gmail.com"
    }
}
...
const getDiscordOnlineUsers = async () => {
    try {
        const 1433173821086761102 = config.serverInfo.1433173821086761102;

        const apiWidgetUrl = `https://discord.com/api/guilds/${1433173821086761102}/widget.json`;
...
const getMinecraftOnlinePlayer = async () => {
    try {
        ...
        const apiUrl = `https://api.mcsrvstat.us/2/${play.emperialcraft.in}`;
